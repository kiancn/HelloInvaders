////
///Indtil videre bruger vi råt og usødet EmeraldObjectPool scriptet, fordi det jeg har lavet stadig knager og braser sammen til tider.
///I øvrigt har scriptet nogle rigtig gode Spawn og Despawn metoder, som skal implementeres.
///Det kan se ud som om mange ting sker to gange og på mærkelige steder, men ved nærmere eftersyn er næsten det hele ganske effektivt.
...
public static class EmeraldObjectPool {
	...
	const int DEFAULT_POOL_SIZE = 25;
